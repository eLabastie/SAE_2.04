...
if choix=='1':
   ...
   plt.show()
    ...
    typeLum=saisieVerif(1, 3, "Saisissez la luminosite à consulter (1,2,3) : ")
    ...
    while(True) :
        ...
        dateFin=saisieVerif("Choisissez la date de fin de la période à consulter (Entre 1984 et 1997) : ")
